...
# 4) Create lifespan context manager for startup/shutdown events
@asynccontextmanager
async def lifespan(app: FastAPI):
    ...
    logger.info("application_shutdown", stage="shutdown")

# 5) Routers (import-guarded so app still boots even if one has an error)
